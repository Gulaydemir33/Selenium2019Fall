...
public class RegistrationForm {
    ...
    public void verifyFirstNameLenghtTest(){
        ...
        BrowserUtils.wait(3);
        WebElement warningMessage = driver.findElement(By.xpath("//small[text()='first name must be more than 64 character long"));
         Assert.assertTrue(warningMessage.isDisplayed());
    }
    @Test
    public void verifyAlphabeticalLettersOnlyTest(){
